    ...
    <footer className="border-t border-gray-800 bg-secondary/50">
      <div className="section-container py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          {/* Social Links */}
          <div>
            <h4 className="text-sm font-semibold text-white mb-4 uppercase tracking-wide">Follow Us</h4>
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-background border border-gray-800 hover:border-primary rounded-lg flex items-center justify-center transition-colors"
                aria-label="LinkedIn"
              >
